...
/* First created by JCasGen Fri Oct 11 01:32:32 EDT 2013 */
package it.pkg.deiis.vector_space.typesystems;
...
/** 
 * Updated by JCasGen Fri Oct 11 01:32:32 EDT 2013
 * XML source: /home/diwang/ur-workspace/basic/src/main/resources/descriptors/typesystems/VectorSpaceTypes.xml
 * @generated */
public class Document extends Annotation {
  ...
  public int getRelevanceValue() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_relevanceValue == null)
      jcasType.jcas.throwFeatMissing("relevanceValue", "it.pkg.deiis.vector_space.typesystems.Document");
  ...
  public int getQueryID() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_queryID == null)
      jcasType.jcas.throwFeatMissing("queryID", "it.pkg.deiis.vector_space.typesystems.Document");
  ...
  public String getText() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "it.pkg.deiis.vector_space.typesystems.Document");
  ...
  public FSList getTokenList() {
    if (Document_Type.featOkTst && ((Document_Type)jcasType).casFeat_tokenList == null)
      jcasType.jcas.throwFeatMissing("tokenList", "it.pkg.deiis.vector_space.typesystems.Document");
